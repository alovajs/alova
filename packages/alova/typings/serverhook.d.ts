/**
 * @alova/server 1.0.0-beta.2 (https://alova.js.org)
...
declare class HookedMethod<AG extends AlovaGenerics = any> implements Method<AG> {
  ...
  get config(): alova.MethodRequestConfig & {
    ...
    cacheFor?:
      | alova.CacheConfig<alova.RespondedAlovaGenerics<AG, AG['Responded'], AG['Transformed']>>
      | alova.CacheController<AG['Responded']>
      | undefined;
    hitSource?: string | RegExp | Method<any> | (string | RegExp | Method<any>)[] | undefined;
    transform?:
      | ((data: AG['Transformed'], headers: AG['ResponseHeader']) => AG['Responded'] | Promise<AG['Responded']>)
      | undefined;
...
declare class LimitedMethod<AG extends AlovaGenerics> extends HookedMethod<AG> {
   ...
   */
  get(options?: { [key: string]: any }): Promise<RateLimiterRes | null>;
  /**
   * Set points by key.
   */
...
declare function createRateLimiter(
  options: RateLimitOptions
): <AG extends AlovaGenerics<any, any, any, any, any, any, any, any, any, any, any>>(
  method: Method<AG>,
  wrapperOption?: LimitHandlerOptions<AG>
) => LimitedMethod<AG>;
...
declare const retry: <AG extends AlovaGenerics<any, any, any, any, any, any, any, any, any, any, any>>(
  method: Method<AG>,
