...
# axios adpater for alova

- Refer to [alova](https://github.com/alovajs/alova)
- Refer to [axios](https://github.com/axios/axios)

## Usage

Please to [adapter axios documentation](https://alova.js.org/resource/request-adapter/axios) for more details.
